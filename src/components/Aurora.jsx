...
export default function Aurora(props) {
  const {
    colorStops = ["#facc15", "#e879f9", "#fb7185"],
    amplitude = 1.0,
    blend = 0.5,
    speed = 1.0,
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      const { time: providedTime, speed: providedSpeed } = propsRef.current;
      const animTime = (providedTime ?? t * 0.01) * (providedSpeed ?? 1.0);
      program.uniforms.uTime.value = animTime * 0.1;
